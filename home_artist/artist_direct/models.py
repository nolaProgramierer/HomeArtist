...
class Profile(models.Model):
    ...
    location = models.CharField(max_length=2, choices=LOCATION_CHOICES, default=USA, blank=True)
    genre = models.CharField(max_length=24, choices=GENRE_CHOICES, default=SOLO, blank=True)
